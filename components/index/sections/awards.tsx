...
export default function IntroduceAwards () {
  ...
  const translateX = useTransform(scrollYProgress, [0.4, 0.8], [-1000, 0])

  return (
    <motion.section id="awards" className="h-screen" style={{ translateX }}>
      <div className="h-screen bg-blue-500 w-5/6 lg:w-2/3 absolute left-0"></div>
        ...
        <div className="h-screen">
          <div className="flex flex-warp justify-between">
            ...
            <div className="text-right text-white my-5">
              <h2 className="font-bold border-b-4 border-blue-500 border-opacity-10 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Awards &</h2>
              <h2 className="font-bold border-b-4 border-blue-500 border-opacity-10 -mt-3 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Reports.</h2>
            </div>
          </div>
